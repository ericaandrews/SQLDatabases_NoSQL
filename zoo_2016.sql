...
/*
Write and run the SQL statement so that it shows only three columns: 
'z_type' in the first column, 'z_name' in the second column, and 'z_cost' in the third column. 
